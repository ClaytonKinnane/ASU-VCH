...
4. Точный committed scope из 29 изменённых путей.
...
10. Compatibility layer собирает 13 частей migration 010 и подтверждает canonical SHA-256.
...
20. Source/deploy parity проходит по runtime-файлам.
