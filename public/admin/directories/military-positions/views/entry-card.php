...
<article class="military-position-entry-card glass-tile <?= $entryStatus === 'archived' ? 'is-archived' : '' ?>">
    ...
    <div class="military-position-entry-actions">
        <details class="military-position-entry-action">
        ...
        <details class="military-position-entry-action military-position-state-action">
            <summary><?= e($stateActionLabel) ?></summary>
