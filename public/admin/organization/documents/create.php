...
organization_handle_action(function () use ($user): string {
    ...
    organizational_structure_service()->addDocument($versionId, organization_post_string('document_type'), organization_post_string('document_date'), organization_post_string('document_number'), organization_post_string('title'), organization_post_nullable_string('note'), organization_post_string('document_role'), $revision, (int) $user['id']);
