...
organization_handle_action(function () use ($user): string {
    ...
    organizational_structure_service()->deleteNode(organization_positive_int($_POST['node_id'] ?? null), organization_post_string('confirm_subtree') === '1', organization_post_nullable_string('reason'), $revision, (int) $user['id']);
