...
organization_handle_action(function () use ($user): string {
    ...
    organizational_structure_service()->moveNode(organization_positive_int($_POST['node_id'] ?? null), organization_positive_int($_POST['parent_node_id'] ?? null), $revision, (int) $user['id']);
