...
<head>
    ...
    <style>
        ...
        .personnel-identifier-card { display: block; padding: 14px 16px; border: 1px solid var(--input-border); border-radius: var(--control-radius); background: var(--input-background); }
        .personnel-identifier-heading { margin: 8px 0 10px; }
    ...
    <section class="organization-panel glass-tile personnel-section">
        ...
        <div class="organization-list">
            <?php foreach ($identifiers as $identifier): ?>
                <article class="personnel-identifier-card">
                    ...
                    <div class="personnel-identifier-actions" aria-label="Действия идентификатора">
                        ...
                        <a class="secondary-button" href="/admin/personnel/identifiers/end.php?personnel_id=<?= (int) $person['id'] ?>&type_id=<?= (int) $identifier['identifier_type_id'] ?>">Прекратить действие идентификатора</a>
                    </div>
                    <?php endif; ?>
                </article>
            <?php endforeach; ?>
